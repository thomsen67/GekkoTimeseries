...
if (gh.isIndex != null) {  if (gh.isIndex == true) {    o0.opt_i = GekkoTime.tNotNull;  }  else {    o0.opt_i = GekkoTime.tNull;  }if (gh.isYoy != null) {  if (gh.isYoy == true) {    o0.opt_yoy = "yes";  }  else {    o0.opt_yoy = "no";  }}
}
