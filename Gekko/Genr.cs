...
o0.opt_i = GekkoTime.tNotNull;


if (gh.isIndex != null) {  if (gh.isIndex == true) {    o0.opt_i = GekkoTime.tNotNull;  }  else {    o0.opt_i = GekkoTime.tNull;  }}ESeriesMissing r1_0 = Program.options.series_array_print_missing; ESeriesMissing r2_0 = Program.options.series_array_calc_missing; ESeriesMissing r3_0 = Program.options.series_data_missing; try {
O.HandleOptionBankRef1(o0.opt_bank, o0.opt_ref); O.HandleMissing1(o0.opt_missing);
{
List<int> bankNumbers = null;
O.Prt.Element ope0 = new O.Prt.Element();
ope0.labelGiven = new List<string>() {"fy|[@5,8:9='fy',<1429>,1:8]|[@5,8:9='fy',<1429>,1:8]"};
...
ope0.variable[bankNumber] = O.Lookup(smpl, null, null, "fy", null, null, new  LookupSettings(), EVariableType.Var, null);
