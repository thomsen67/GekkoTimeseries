            ...
            Func<GraphHelper, string> print0 = (gh) =>
            {
...

                {
                    ...
                    for (int bankNumberI = 0; bankNumberI < bankNumbers.Count; bankNumberI++)
                    {
                        ...
                        ope0.variable[bankNumber] = O.Lookup(smpl, null, (O.ReportInterior(smpl, O.ListDefHelper(new ScalarString(ScalarString.SubstituteScalarsInString(@"a", true, false)), new ScalarString(ScalarString.SubstituteScalarsInString(@"b", true, false))), 0, labelCounter)), null, false, EVariableType.Var);
