...
namespace Gekko
{
    public class Range : IVariable
    {
        ...
        {
            new Error("Wrong use of Range class");
        ...
        {
            new Error("Type error regarding concat and Range class");
            throw new GekkoException();
        }
        ...
        {
            new Error("You cannot use an indexer [] on a range");
            throw new GekkoException();
        }
