...
namespace Gekko
{
    ...
    class Translator_Gekko20_Gekko30
    {
        ...
        public static string TranslateMove(string input)  //for translate<move>
        {
            string txt = input;
            var tags1 = new List<Tuple<string, string>>() { new Tuple<string, string>("/*", "*/") };
            var tags2 = new List<string>() { "//" };
        ...
        public static string TranslateRemove(string input)  //for translate<move>
        {
            string txt = input;
            var tags1 = new List<Tuple<string, string>>() { new Tuple<string, string>("/*", "*/") };
            var tags2 = new List<string>() { "//" };
        ...
        public static void HandleExpressionsRecursive(List<TokenHelper> line, List<TokenHelper> topline)
        {
            ...
            for (int i = 0; i < line.Count; i++)
            {
                ...
                if (StringTokenizer.Equal(line, i, "difference") && i + 1 < line.Count && line[i + 1].subnodes != null && line[i + 1].subnodes[0].s == "(")
                {
                    line[i].s = "except";
                }
                ...
                else if (StringTokenizer.Equal(line, i, "avgt") && i + 1 < line.Count && line[i + 1].subnodes != null && line[i + 1].subnodes[0].s == "(")
                {
        ...
        public static void TranslateHandleMove(List<TokenHelper> line)
        {
            int pos = 0;
        ...
        public static void TranslateHandleRemove(List<TokenHelper> line)
        {
            int pos = 0;
        ...
        {
            int op_1 = StringTokenizer.FindS(line, 0, new string[] { "=" });
            if (op_1 != -12345)
            {
                if (StringTokenizer.FindS(line, op_1 + 1, new string[] { "=" }) != -12345) return;  //this would be strange
