...
{   
    ...
    public class Globals        
    {
        ...
        public static double[] gradientX0 = null;
        public static double[] gradientX = null;
        // ----------------------------------------------------------------
        ...
        public static Dictionary<string, Func<GekkoSmpl, P, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable>> ufunctions11 = new Dictionary<string, Func<GekkoSmpl, P, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable, IVariable>>();
        ...
        public const string reportLabel1 = "O.ReportLabel(smpl, ";
