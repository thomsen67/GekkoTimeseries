...
namespace Gekko
{
    ...
    public class Globals
    {
        ...
        public static List<string> browserPlotFiles = null;
        ...
        public static List<string> gbkVersions = new List<string> { "1.0", "1.1", "1.2" };  //1.0 = zipped tsd, 1.1 = protobuffers, 1.2 = Gekko 3.0 protobuffers.
        public static List<string> traceVersions = new List<string> { "1.0" };  //1.0 = version from Gekko 3.1.16 (gbk version 1.2).
        ...
        public const string operator_a = "a";
        ...
        public const string operator_al = "al";
        public const string operator_adl = "adl";
        public const string operator_a3 = "a3";
        ...
        public static List<string> operators_a = new List<string>() { operator_a, operator_an, operator_ad, operator_ap, operator_adp, operator_a3, operator_a3n, operator_a3d, operator_a3p, operator_a3dp, operator_al, operator_adl, operator_a3l, operator_a3dl };
        ...
        public const string tracePrecedentsTypeDelimiter = "¤";  //used in tracing.
        ...
        public static int guiTableCellWidthFirst = 160;
        ...
        public static int databankSearchHitBelowFirstPosition = 0; //Used for a warning in PLOT, when the first-position databank has > 0 variables but a variable was found in position 2 or lower in the F2 window.
        ...
        //public static long traceCounter2 = G.NextLong(Globals.random, 1, (long)(0.99d * (double)long.MaxValue)); //See above
        ...
        public static double tiny = 1.7777e-301;  //for something like log(x + tiny()), guarding against x == 0. The number will not add easily up to 1e-300.
