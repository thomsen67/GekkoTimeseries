...
namespace Gekko
{
    ...
    public class Globals
    {
        ...
        public const bool traceFixAccumulationProblem = true;  //For x = x + ... , traces of x at depth=1 are dropped if they are already at depth=0 and are not shadowed by x = x + ...
