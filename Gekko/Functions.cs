...
namespace Gekko
{
    ...
    public class Functions
    {
        ...
        {
            return Functions.ras(smpl, _t1, _t2, a, rowSums, colSums, rowNames, colNames, new Map());
        }

        public static IVariable ras(GekkoSmpl smpl, IVariable _t1, IVariable _t2, IVariable a, IVariable rowSums, IVariable colSums, IVariable rowNames, IVariable colNames, IVariable options)
        {
            GekkoTime t1, t2; helper_TimeOptionField(smpl, _t1, _t2, out t1, out t2);
            return Optimize.Ras1(t1, t2, a, rowSums, colSums, rowNames, colNames, null, null, options);
        }
