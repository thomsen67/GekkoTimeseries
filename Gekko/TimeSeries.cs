...
{    
    ...
    public class TimeSeries
    {
        ...
        {
            if (this.parentDatabank != null && this.parentDatabank.protect) Program.ProtectError("You cannot truncate a timeseries residing in a protected databank");            
        ...
        {            
            ...
            if (this.parentDatabank != null && this.parentDatabank.protect) Program.ProtectError("You cannot change an observation in a timeseries residing in a protected databank");
        ...
        {
            if (this.parentDatabank != null && this.parentDatabank.protect) Program.ProtectError("You cannot change observations in a timeseries residing in a protected databank");
            //Program.ErrorIfDatabanksSwapped(this);
            if (this.freqEnum != gt1.freq || gt1.freq != gt2.freq)
            {
                //This check: better safe than sorry!
