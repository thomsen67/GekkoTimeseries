...
namespace Gekko
{
    public class Options
    {
        ...
        public string databank_dlink_folder_storage = "k:\\MAKROBK_KILDE\\2025_10_01\\_storage";
        ...
        public string databank_dlink_folder_replace3a = "_kilde";
        ...
        public int databank_dlink_cache = 50000; //We have about 3000 datafiles, so this should be more than enough for smoothness. Zipped protobuf cache should be around 3 MB for this.
        ...
        public static List<List<string>> Syntax()
        {
            ...
            Add("DATABANK DLINK FOLDER STORAGE", Globals.xnameOrString, "dlink");
            ...
            Add("DATABANK DLINK FOLDER REPLACE4A", Globals.xnameOrString, "dlink");
            Add("DATABANK DLINK FOLDER REPLACE4B", Globals.xnameOrString, "dlink");
            Add("DATABANK DLINK CACHE", Globals.xsint);
