...
namespace Gekko
{
    public class Options
    {
        ...
        public bool bugfix_lhsscore = true;        //not mentioned in help
        public bool bugfix_residuals = true;        //not mentioned in help
        // ---
        ...
        public string system_write_encoding = "ansi"; // [ansi | utf8]       (ansi is windows-1252). Set this to "utf8" for Gekko 4.0.
        ...
        public static List<List<string>> Syntax()
        {
            ...
            Add("BUGFIX RESIDUALS", Globals.xbool);
