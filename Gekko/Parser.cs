...
namespace Gekko
{
    ...
    public enum EEquationType
    {
        ...
        RevertedL,  //table variables that are run after simulation (same as RevertedT, but will be evaluated from t1-i to t2, if there is a lead x[+i] in the model) 
    ...
    {       
        ...
        {
            return eh.equationType == EEquationType.RevertedAutoGenerated || eh.equationType == EEquationType.RevertedY || eh.equationType == EEquationType.RevertedT || eh.equationType == EEquationType.RevertedL;
        }
        ...
        private static void ExtractDJZAndEquationTypeFromEquationCode(EquationHelper eh, ModelGekko model, bool isModel)
        {
            ...
            else if (G.Equal(code.Substring(0, 1), "t")) //FRML t... for table variables
            {
                eh.equationType = EEquationType.RevertedT;
                return;
            }
            else if (G.Equal(code.Substring(0, 1), "l")) //FRML l... for table variables with leads
            {
                eh.equationType = EEquationType.RevertedL;
                return;
            }
