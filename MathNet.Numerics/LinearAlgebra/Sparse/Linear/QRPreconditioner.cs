...
namespace MathNet.Numerics.LinearAlgebra.Sparse.Linear
{
	...
	/// supported.
	/// </summary>
	public class QRPreconditioner : AbstractPreconditioner, IPreconditioner
	{
		/// <summary> The decomposition</summary>
		private QRDecomposition decomp;
		...
		{
			decomp = new QRDecomposition(new Matrix(Blas.Default.GetArrayCopy(A)));
		}
	}
}