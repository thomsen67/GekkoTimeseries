...
namespace MathNet.Numerics.LinearAlgebra.Sparse.Linear
{
	...
	/// </summary>
	public class CholeskyPreconditioner : AbstractPreconditioner, IPreconditioner
	{
		/// <summary> The decomposition</summary>
		private CholeskyDecomposition decomp;
		...
		{
			decomp = new CholeskyDecomposition(new Matrix(Blas.Default.GetArrayCopy(A)));
		}
	}
}