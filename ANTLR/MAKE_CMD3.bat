...
"c:\Thomas\Software\Java\jre6\bin\java.exe" -classpath C:\Thomas\Software\ANTLR\antlr-3.1.3.jar -Xmx500m org.antlr.Tool -Xconversiontimeout 120000 -traceParser Cmd3.g >> ljadsf
pause
