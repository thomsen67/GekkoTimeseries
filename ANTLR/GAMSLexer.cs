...
public partial class GAMSLexer : Lexer {
    ...
    public void mCOMMENT1() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            ...
            // GAMS.g:304:30: ( '#' ) (~ ( NEWLINE2 | NEWLINE3 ) )*
            {
            	...
            	// GAMS.g:304:36: (~ ( NEWLINE2 | NEWLINE3 ) )*
            	do 
            	{
            	    int alt1 = 2;
    ...
    public void mCOMMENT2() // throws RecognitionException [2]
    {
            ...
            int _type = COMMENT2;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // GAMS.g:305:9: ( ( '!!' ) (~ ( NEWLINE2 | NEWLINE3 ) )* )
            // GAMS.g:305:30: ( '!!' ) (~ ( NEWLINE2 | NEWLINE3 ) )*
            {
            	// GAMS.g:305:30: ( '!!' )
            	// GAMS.g:305:31: '!!'
            	{
            	...
            	// GAMS.g:305:37: (~ ( NEWLINE2 | NEWLINE3 ) )*
            	do 
            	{
            	    int alt2 = 2;
            		...
            		{
            			case 1 :
            			    // GAMS.g:305:38: ~ ( NEWLINE2 | NEWLINE3 )
            			    {
            			    	if ( (input.LA(1) >= '\u0000' && input.LA(1) <= '\t') || (input.LA(1) >= '\u000B' && input.LA(1) <= '\uFFFF') ) 
            			    	{
            			    	    input.Consume();
    ...
    public void mDouble() // throws RecognitionException [2]
    {
            ...
            int _type = Double;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // GAMS.g:347:5: ( ( '0' .. '9' )+ DOT ( '0' .. '9' )* ( Exponent )? | DOT ( '0' .. '9' )+ ( Exponent )? | ( '0' .. '9' )+ Exponent )
            int alt11 = 3;
            alt11 = dfa11.Predict(input);
            switch (alt11) 
            {
                case 1 :
                    // GAMS.g:348:8: ( '0' .. '9' )+ DOT ( '0' .. '9' )* ( Exponent )?
                    {
                    	// GAMS.g:348:8: ( '0' .. '9' )+
                    	int cnt5 = 0;
                    	do 
    ...
    public void mIdent() // throws RecognitionException [2]
    {
            ...
            int _type = Ident;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // GAMS.g:353:7: ( ( LETTER | '_' ) ( DIGIT | LETTER | '_' )* )
            // GAMS.g:353:9: ( LETTER | '_' ) ( DIGIT | LETTER | '_' )*
            {
    ...
    public void mComment() // throws RecognitionException [2]
    {
            ...
            int _type = Comment;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // GAMS.g:359:12: ( ( '()' | '//' ) (~ ( NEWLINE2 | NEWLINE3 ) )* )
            // GAMS.g:359:14: ( '()' | '//' ) (~ ( NEWLINE2 | NEWLINE3 ) )*
            {
            	// GAMS.g:359:14: ( '()' | '//' )
            	int alt15 = 2;
            	...
            	// GAMS.g:359:28: (~ ( NEWLINE2 | NEWLINE3 ) )*
            	do 
            	{
            	    int alt16 = 2;
            		...
            		{
            			case 1 :
            			    // GAMS.g:359:29: ~ ( NEWLINE2 | NEWLINE3 )
            			    {
            			    	if ( (input.LA(1) >= '\u0000' && input.LA(1) <= '\t') || (input.LA(1) >= '\u000B' && input.LA(1) <= '\uFFFF') ) 
            			    	{
            			    	    input.Consume();
    ...
    public void mNESTED_ML_COMMENT() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // GAMS.g:363:5: ( '/*' ( options {greedy=false; } : NESTED_ML_COMMENT | . )* '*/' )
            // GAMS.g:363:9: '/*' ( options {greedy=false; } : NESTED_ML_COMMENT | . )* '*/'
            {
            	Match("/*"); 

            	// GAMS.g:364:9: ( options {greedy=false; } : NESTED_ML_COMMENT | . )*
            	do 
            	{
            	    int alt17 = 3;
            		...
            		{
            			case 1 :
            			    // GAMS.g:364:36: NESTED_ML_COMMENT
            			    {
            			    	mNESTED_ML_COMMENT(); 
    ...
    public void mExponent() // throws RecognitionException [2]
    {
    		try
    		{
            // GAMS.g:385:5: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // GAMS.g:385:9: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    protected class DFA11 : DFA
    {
        ...
        {
            get { return "346:1: Double : ( ( '0' .. '9' )+ DOT ( '0' .. '9' )* ( Exponent )? | DOT ( '0' .. '9' )+ ( Exponent )? | ( '0' .. '9' )+ Exponent );"; }
        }
