// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 T2.g 2016-03-02 10:14:52
...
public partial class T2Lexer : Lexer {
    ...
    public void mExponent() // throws RecognitionException [2]
    {
    		try
    		{
            // T2.g:228:27: ( E_ ( '+' | '-' )? ( DIGIT )+ )
            // T2.g:228:29: E_ ( '+' | '-' )? ( DIGIT )+
            {
            	mE_(); 
            	// T2.g:228:32: ( '+' | '-' )?
            	int alt1 = 2;
    ...
    public void mCOMMENT() // throws RecognitionException [2]
    {
            ...
            int _type = COMMENT;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // T2.g:234:27: ( ( '!' ) (~ ( NEWLINE2 | NEWLINE3 ) )* )
            // T2.g:234:29: ( '!' ) (~ ( NEWLINE2 | NEWLINE3 ) )*
            {
            	// T2.g:234:29: ( '!' )
            	// T2.g:234:30: '!'
            	{
    ...
    public void mIdent() // throws RecognitionException [2]
    {
            ...
            int _type = Ident;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // T2.g:237:27: ( ( LETTER | '_' ) ( DIGIT | LETTER | '_' )* )
            // T2.g:237:29: ( LETTER | '_' ) ( DIGIT | LETTER | '_' )*
            {
    ...
    public void mDigitsEDigits() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // T2.g:246:27: ( ( DIGIT )+ ( E_ ) ( DIGIT )+ )
            // T2.g:246:29: ( DIGIT )+ ( E_ ) ( DIGIT )+
            {
            	// T2.g:246:29: ( DIGIT )+
            	int cnt10 = 0;
            	do 
    ...
    public void mDateDef() // throws RecognitionException [2]
    {
            ...
            int _type = DateDef;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // T2.g:248:27: ( ( DIGIT )+ ( A_ | Q_ | M_ ) ( DIGIT )+ )
            // T2.g:248:29: ( DIGIT )+ ( A_ | Q_ | M_ ) ( DIGIT )+
            {
            	// T2.g:248:29: ( DIGIT )+
            	int cnt12 = 0;
            	do 
    ...
    public void mIdentStartingWithInt() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // T2.g:250:27: ( ( DIGIT | LETTER | '_' )+ )
            // T2.g:250:29: ( DIGIT | LETTER | '_' )+
            {
            	// T2.g:250:29: ( DIGIT | LETTER | '_' )+
            	int cnt14 = 0;
            	do 
    ...
    public void mDouble() // throws RecognitionException [2]
    {
            ...
            int _type = Double;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // T2.g:252:27: ( ( DIGIT )+ DOT ( DIGIT )* ( Exponent )? | ( DIGIT )+ Exponent | DOT ( DIGIT )+ ( Exponent )? )
            int alt21 = 3;
            alt21 = dfa21.Predict(input);
            switch (alt21) 
            {
                case 1 :
                    // T2.g:252:29: ( DIGIT )+ DOT ( DIGIT )* ( Exponent )?
                    {
                    	// T2.g:252:29: ( DIGIT )+
                    	int cnt15 = 0;
                    	do 
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // T2.g:254:11: DOT ( DIGIT )+ ( Exponent )?
                    {
                    	mDOT(); 
                    	// T2.g:254:15: ( DIGIT )+
                    	int cnt19 = 0;
    ...
    protected class DFA21 : DFA
    {
        ...
        {
            get { return "252:1: Double : ( ( DIGIT )+ DOT ( DIGIT )* ( Exponent )? | ( DIGIT )+ Exponent | DOT ( DIGIT )+ ( Exponent )? );"; }
        }
